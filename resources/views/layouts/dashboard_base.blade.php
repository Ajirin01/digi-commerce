    ...
    <div class="wrapper">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{asset('site/dashboard/dist/img/user1-128x128.jpg')}}"
                    alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{asset('site/dashboard/dist/img/user8-128x128.jpg')}}"
                    alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{asset('site/dashboard/dist/img/user3-128x128.jpg')}}"
                    alt="User Avatar"
                    class="img-size-50 img-circle mr-3"
                  />
                  <div class="media-body">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{url('dashboard')}}" class="brand-link">
          <img
            src="{{asset('site/images/digi-logo-dashboard.png')}}"
            alt="digi-realm Logo"
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img
                src="{{asset('site/dashboard/dist/img/user2-160x160.jpg')}}"
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="{{url('dashboard/calender')}}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{url('dashboard/records')}}" class="nav-link">
