  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ url('admin/dashboard') }}" class="brand-link">
        <img src="{{asset('assets/images/menu/logo/1.png')}}" alt="AdminLTE Logo" class="brand-image elevation-3"
            style="opacity: .8">
      </a>
            ...
            @can('isSeller')
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('product.create.options')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add Product(s)</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="{{ route('product.bulk.update.options')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $sales_seller }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
            ...
            <div class="row">
              <div class="col-md-12">
                <p class="text-center">
                  ...
                  <span class="text-danger">Total:</span> <strong>N {{ number_format( $sales_total ) }}.00</strong></strong>  
                  @endif
