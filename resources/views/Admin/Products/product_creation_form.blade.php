                ...
                <form action="{{ route('products.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      <div class="form-group">
                          <label>Shop</label>
                          <select name="shop_id" class="form-control" aria-readonly="true">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" name="percent_off" id="" class="form-control">
                  </div>
                  <div class="mb-3">
                    <label>Sale starts</label>
                    <input type="datetime-local" name="sale_start" id="" class="form-control">
                  </div>
