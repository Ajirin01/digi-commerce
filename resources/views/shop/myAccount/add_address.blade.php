    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12 col-12">
                <form action="{{ URL::to('account/address') }}" id="place_order_form" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <input placeholder="Street address" id="address" type="text" name="street_address" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input placeholder="" id="city" type="text" name="city" id="city" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <select name="lga" id="lga" ng-model="shipping_cost" class="form-control">
