...
@section('content')
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="slider-banner banner-item img-hover_effect">
                                <a href="shop-left-sidebar.html">
                                    <img class="img-full" src="assets/images/banner/2-1.jpg" alt="Banner">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6">
                            <div class="slider-banner-2 banner-item img-hover_effect">
                                <a href="shop-left-sidebar.html">
                                    <img class="img-full" src="assets/images/banner/2-2.jpg" alt="Banner">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner-slide">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="product/1">
                                            <img class="primary-img" src="assets/images/product/medium-size/1-1.jpg" alt="Product Image">
                                            <img class="secondary-img" src="assets/images/product/medium-size/4-1.jpg" alt="Product Image">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            ...
                                            <h6 class="product-name"><a href="product/1">Veniam officiis voluptates</a></h6>
                                            <div class="price-box">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="uren-add_cart" href="product/1" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i
                        ...
                        <div class="slide-item">
                            <div class="inner-slide">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="product/1">
                                            <img class="primary-img" src="assets/images/product/medium-size/4-2.jpg" alt="Product Image">
                                            <img class="secondary-img" src="assets/images/product/medium-size/5-2.jpg" alt="Product Image">
                                        </a>
                                        <div class="sticker-area-2">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            ...
                                            <h6 class="product-name"><a href="product/1">Accusantium corporis odio</a></h6>
                                            <div class="price-box">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="uren-add_cart" href="product/2" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i
                                                            class="ion-bag"></i>Add To Cart</a>
                                                    </li>
                                                    <li><a class="uren-wishlist" href="wishlist.html" data-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i class="ion-android-favorite-outline"></i></a>
                                                    </li>
                        ...
                        <div class="slide-item">
                            <div class="inner-slide">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="product/1">
                                            <img class="primary-img" src="assets/images/product/medium-size/6-1.jpg" alt="Product Image">
                                            <img class="secondary-img" src="assets/images/product/medium-size/6-2.jpg" alt="Product Image">
                                        </a>
                                        <div class="sticker-area-2">
                                ...
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="uren-add_cart" href="product/{{$product->id}}?{{$product->name}}" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="ion-bag"></i></a>
                                                    </li>
                                                    @auth
                                                    ...
                                                    @endauth
                                                    {{-- <li class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter{{$product->id}}"><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Quick View"><i
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="assets/images/banner/1-3.jpg" alt="Banner">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
    ...
    <!-- Begin Best Selling Product Area -->
        ...
        <div class="container-fluid">
            ...
            <div class="row no-gutters">
                <div class="col-xl-2 col-md-4 col-sm-4">
                    <div class="banner-item best-selling_banner img-hover_effect"></div>
                </div>
    ...
    <!-- Best Selling Product Area End Here -->
